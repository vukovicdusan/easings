...
function easeInOutQuad(
	...
	if ((currentIteration /= totalIterations / 2) < 1) {
		return (
			(changeInValue / 2) * currentIteration * currentIteration +
			startValue
		)
	}
	return (
		(-changeInValue / 2) *
			(--currentIteration * (currentIteration - 2) - 1) +
		startValue
	)
}
...
function easeInOutCubic(
	...
	return (
		(changeInValue / 2) * (Math.pow(currentIteration - 2, 3) + 2) +
		startValue
	)
}
...
function easeInOutQuart(
	...
	return (
		(-changeInValue / 2) * (Math.pow(currentIteration - 2, 4) - 2) +
		startValue
	)
}
...
function easeInOutQuint(
	...
	return (
		(changeInValue / 2) * (Math.pow(currentIteration - 2, 5) + 2) +
		startValue
	)
}
...
function easeInSine(
	...
	return (
		changeInValue *
			(1 -
				Math.cos(
					(currentIteration / totalIterations) * (Math.PI / 2)
				)) +
		startValue
	)
}
